...
\end{figure}
Die in \cref{fig:temp-prof,fig:temp-array} dargestellten Profile lassen sich mit den aus der Simulation gewonnenen Profilen für unterschiedliche Rayleigh-Zahlen vergleichen.
...
\end{figure}
\begin{figure}
	\input{Figures/vel_corr_therm}\caption{Aus den Korrelationen bestimmte Werte für die Geschwindigkeit in Abhängigkeit vom Abstand von der Kühlplatte. Das erwartete Profil mit Minimum in der Mitte, wie in \cref{fig:SimVprof} ist nicht zu erkennen.}\label{fig:v_korr}
\end{figure}
...
\input{multiplot}
\FloatBarrier
\subsection{Bestimmung der Nusselt-Zahl}
